...
# Installation
**To install this project, run a git pull from the following URL [Github](https://github.com/noahfred97/Challenge-1) and the project website can also be viewed directly at [Website](https://noahfred97.github.io/Challenge-1/) if you would like to directly view the final outcome of the project.**

# Usage
**After running a Git Pull from the Git Repository, open the folder in VS Code Source to contribute to or edit the code. If you would like simply like to view the Webpage, click on [Website](https://noahfred97.github.io/Challenge-1/), and you can see what the end product looks like!**
